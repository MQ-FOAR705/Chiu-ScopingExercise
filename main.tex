...
Of the jobs that could relieve pain or generate gains that a tool or technique could be applied to such as assistance with a research plan, better data organisation for a literature review or making formatting and referencing easier, automating data collection would benefit me the most. It would result in substantially improve research for my thesis and also free up the most time from quite tedious work. I have also chosen it because it is more difficult for me to work out how to go about doing this job and assistance would be helpful. 

\section*{Computational analysis}
It is important to breaking down this data collection job into discrete tasks and steps. 

\subsection*{Decomposing}
There are a range of discrete tasks for this job. These will include:
\begin{itemize}
...
\begin{enumerate}
    \item determine what you want to find out
    \item doing some initial research to identify key time periods and common terminology used;
    \item determining what are the likely keywords for sources;
    ...
    \item using the tool, if the test is successful, searching the sources and databases using the keywords;
    \item saving the sources identified;
    \item producing and saving metadata used for searches;
    \item organising the saved sources; 
    \item analysing the saved sources; and
    \item repeating the process e.g. using information to come up with new keywords to find any further sources and more information on any possible case studies that are identified.
\end{enumerate}
